...
// Normal Routes ===============================================================
    ...
    app.get('/profile', isLoggedIn, function(req, res) {
        db.collection('increments').find().toArray((err, result) => {
...
// Routes ===============================================================
    ...
    app.post('/increments', (req, res) => {
        db.collection('increments').save({ increment: req.body.increment }, (err, result) => {
            if (err) return console.log(err)
    ...
    app.put('/increments', (req, res) => {
        db.collection('increments')
            .findOneAndUpdate(
                { increment: req.body.increment }, 
                { $set: { alignment: req.body.alignment } },
                (err, result) => {
    ...
    app.delete('/increments', (req, res) => {
        db.collection('increments').findOneAndDelete({ increment: req.body.increment }, (err, result) => {
